...
class AgentProcess
{
	...
	this(string[] args, string[string] env = null, string workDir = null)
	{
		...
		auto stdoutFd = dup(stdoutPipe.readEnd.fileno);
		auto stderrFd = dup(stderrPipe.readEnd.fileno);
		...
		auto stdinConn = new FileConnection(stdinFd);
		...
		// Line-buffered adapters for NDJSON
