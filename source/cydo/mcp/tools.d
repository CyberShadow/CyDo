...
interface CydoTools
{
	...
	@Description(
		...
		~ "- Include all necessary information in the prompt. The agent doesn't "
		~ "have access to your context (or the context of any other task), "
		~ "so ensure the prompt is self-contained.\n"
