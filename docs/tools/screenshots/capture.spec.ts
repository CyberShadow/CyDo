...
for (const theme of ['dark', 'light'] as const) {
  test.describe(`${theme} theme`, () => {
    ...
    test('conversation', async ({ page }) => {
      ...
      await page.screenshot({ path: `${OUTPUT_DIR}/conversation-${theme}.png` });
    });
    ...
    test('file-viewer', async ({ page }) => {
      ...
      await page.screenshot({ path: `${OUTPUT_DIR}/file-viewer-${theme}.png` });
    });
    ...
    test('search', async ({ page }) => {
      ...
      await page.screenshot({ path: `${OUTPUT_DIR}/search-${theme}.png` });
    });
    ...
    test('tool-calls', async ({ page }) => {
      ...
      await page.screenshot({ path: `${OUTPUT_DIR}/tool-calls-${theme}.png` });
    });
    ...
    test('mobile-file-viewer', async ({ page }) => {
      ...
      await page.screenshot({ path: `${OUTPUT_DIR}/mobile-conversation-${theme}.png` });
    });
    ...
    test('mobile-sidebar', async ({ page }) => {
      ...
      await page.screenshot({ path: `${OUTPUT_DIR}/mobile-sidebar-${theme}.png` });
    });
  });
}
